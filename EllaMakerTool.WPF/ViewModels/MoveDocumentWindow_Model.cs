...
namespace EllaMakerTool.WPF.ViewModels
{
    ...
    public class MoveDocumentWindow_Model : ViewModelBase<MoveDocumentWindow_Model>
    {
        ...
        #region Property ObservableCollection<DocumentTreeNodelApiModel> TreeSource Setup        
        protected Property<ObservableCollection<DocumentTreeNodelApiModel>> _TreeSource = new Property<ObservableCollection<DocumentTreeNodelApiModel>> { LocatorFunc = _TreeSourceLocator };
        static Func<BindableBase, ValueContainer<ObservableCollection<DocumentTreeNodelApiModel>>> _TreeSourceLocator = RegisterContainerLocator<ObservableCollection<DocumentTreeNodelApiModel>>("TreeSource", model => model.Initialize("TreeSource", ref model._TreeSource, ref _TreeSourceLocator, _TreeSourceDefaultValueFactory));
        static Func<ObservableCollection<DocumentTreeNodelApiModel>> _TreeSourceDefaultValueFactory = () => new ObservableCollection<DocumentTreeNodelApiModel>();
        #endregion
