...
using EllaMakerTool.SocketModel;
...
namespace EllaMakerTool
{
    public class SocketHelper
    {
        ...
        public class TcpServer : SocketObject
        {
            ...
            /// 欢迎消息
            /// </summary>
            private string boundary = "您已接入 齐集科技 考勤机控制中心";
            /// <summary>
            /// 当前监听端口
            /// </summary>
            private int Port;
            ...
            public void SendreqToClient(IPEndPoint ip,SocketRequestBase obj)
            {
                SendToClient(ip,JsonConvert.SerializeObject(obj));
            }
            /// <summary>
            /// 发送回执
            /// </summary>
            /// <param name="obj"></param>
            public void SendresToClient(SocketResponseBase obj)
            {
                SendToClient(ip,JsonConvert.SerializeObject(obj));
            }
            /// <summary>
        ...
        public class TcpClients : SocketObject
        {
            ...
            /// </summary>
            /// <param name="obj"></param>
            public void Sendreq(SocketRequestBase obj)
            {
            ...
            /// </summary>
            /// <param name="obj"></param>
            public void Sendres(SocketResponseBase obj)
            {
                SendData(JsonConvert.SerializeObject(obj));
            }
